...
extern "C" {static PyObject *meth_QAbstractItemDelegate_sender(PyObject *, PyObject *);}
static PyObject *meth_QAbstractItemDelegate_sender(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "B", &sipSelf, sipType_QAbstractItemDelegate, &sipCpp))
        {
            QObject *sipRes = 0;
...
#line 529 "/home/tsheasha/GUC/Bachelors/android-python27/python-build/PyQt-x11-gpl-4.8/sip/QtCore/qobject.sip"
        ...
        #endif
#line 489 "sipQtGuiQAbstractItemDelegate.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_sender, NULL);
...
static PyObject *meth_QAbstractItemDelegate_receivers(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BG", &sipSelf, sipType_QAbstractItemDelegate, &sipCpp, &a0))
        {
            int sipRes = 0;
...
#line 546 "/home/tsheasha/GUC/Bachelors/android-python27/python-build/PyQt-x11-gpl-4.8/sip/QtCore/qobject.sip"
        ...
        #endif
#line 531 "sipQtGuiQAbstractItemDelegate.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_receivers, NULL);
...
static PyObject *meth_QAbstractItemDelegate_timerEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QAbstractItemDelegate, &sipCpp, sipType_QTimerEvent, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_timerEvent, NULL);
...
static PyObject *meth_QAbstractItemDelegate_childEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QAbstractItemDelegate, &sipCpp, sipType_QChildEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_childEvent, NULL);
...
static PyObject *meth_QAbstractItemDelegate_customEvent(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QAbstractItemDelegate, &sipCpp, sipType_QEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_customEvent, NULL);
...
static PyObject *meth_QAbstractItemDelegate_connectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_connectNotify, NULL);
...
static PyObject *meth_QAbstractItemDelegate_disconnectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_disconnectNotify, NULL);
...
static PyObject *meth_QAbstractItemDelegate_sizeHint(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_sizeHint, NULL);
...
static PyObject *meth_QAbstractItemDelegate_createEditor(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_createEditor, NULL);
...
static PyObject *meth_QAbstractItemDelegate_setEditorData(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_setEditorData, NULL);
...
static PyObject *meth_QAbstractItemDelegate_setModelData(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_setModelData, NULL);
...
static PyObject *meth_QAbstractItemDelegate_updateEditorGeometry(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_updateEditorGeometry, NULL);
...
static PyObject *meth_QAbstractItemDelegate_editorEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_editorEvent, NULL);
...
static PyObject *meth_QAbstractItemDelegate_elidedText(PyObject *, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_elidedText, NULL);
...
static PyObject *meth_QAbstractItemDelegate_helpEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QAbstractItemDelegate, sipName_helpEvent, NULL);
...
static sipEncodedTypeDef supers_QAbstractItemDelegate[] = {{133, 0, 1}};
...
static PyMethodDef methods_QAbstractItemDelegate[] = {
    ...
    {SIP_MLNAME_CAST(sipName_sender), meth_QAbstractItemDelegate_sender, METH_VARARGS, NULL},
...
static sipEnumMemberDef enummembers_QAbstractItemDelegate[] = {
    {sipName_EditNextItem, QAbstractItemDelegate::EditNextItem, 3},
    {sipName_EditPreviousItem, QAbstractItemDelegate::EditPreviousItem, 3},
    {sipName_NoHint, QAbstractItemDelegate::NoHint, 3},
    {sipName_RevertModelCache, QAbstractItemDelegate::RevertModelCache, 3},
    {sipName_SubmitModelCache, QAbstractItemDelegate::SubmitModelCache, 3},
};


/* Define this type's PyQt4 signals. */
static const pyqt4QtSignal pyqt4_signals_QAbstractItemDelegate[] = {
    {"sizeHintChanged(QModelIndex)", 0, 0},
    {"closeEditor(QWidget *,QAbstractItemDelegate::EndEditHint)", 0, 0},
    {"closeEditor(QWidget *)", 0, 0},
    {"commitData(QWidget *)", 0, 0},
    {0, 0, 0}
};
...
pyqt4ClassTypeDef sipTypeDef_QtGui_QAbstractItemDelegate = {
{
    ...
    },
    {
        sipNameNr_QAbstractItemDelegate,
        {0, 0, 1},
        16, methods_QAbstractItemDelegate,
