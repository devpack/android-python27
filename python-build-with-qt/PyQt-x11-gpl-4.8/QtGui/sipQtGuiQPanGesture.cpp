...
{
    return (sip_QtGui_qt_metacast && sip_QtGui_qt_metacast(sipPySelf,sipType_QPanGesture,_clname)) ? this : QPanGesture::qt_metacast(_clname);
}
...
void sipQPanGesture::sipProtectVirt_connectNotify(bool sipSelfWasArg,const char *a0)
{
    (sipSelfWasArg ? QObject::connectNotify(a0) : connectNotify(a0));
}

void sipQPanGesture::sipProtectVirt_disconnectNotify(bool sipSelfWasArg,const char *a0)
{
    (sipSelfWasArg ? QObject::disconnectNotify(a0) : disconnectNotify(a0));
}


extern "C" {static PyObject *meth_QPanGesture_sender(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_sender(PyObject *sipSelf, PyObject *sipArgs)
{
...
#line 529 "/home/tsheasha/GUC/Bachelors/android-python27/python-build/PyQt-x11-gpl-4.8/sip/QtCore/qobject.sip"
        ...
        #endif
#line 345 "sipQtGuiQPanGesture.cpp"
    ...
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_sender, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_receivers(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_receivers(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BG", &sipSelf, sipType_QPanGesture, &sipCpp, &a0))
        {
            int sipRes = 0;
...
#line 546 "/home/tsheasha/GUC/Bachelors/android-python27/python-build/PyQt-x11-gpl-4.8/sip/QtCore/qobject.sip"
        ...
        #endif
#line 387 "sipQtGuiQPanGesture.cpp"
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_receivers, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_timerEvent(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_timerEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QPanGesture, &sipCpp, sipType_QTimerEvent, &a0))
        {
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_timerEvent, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_childEvent(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_childEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QPanGesture, &sipCpp, sipType_QChildEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_childEvent, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_customEvent(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_customEvent(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QPanGesture, &sipCpp, sipType_QEvent, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_customEvent, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_connectNotify(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_connectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_connectNotify, NULL);

    return NULL;
}


extern "C" {static PyObject *meth_QPanGesture_disconnectNotify(PyObject *, PyObject *);}
static PyObject *meth_QPanGesture_disconnectNotify(PyObject *sipSelf, PyObject *sipArgs)
{
    PyObject *sipParseErr = NULL;
    bool sipSelfWasArg = (!sipSelf || sipIsDerived((sipSimpleWrapper *)sipSelf));
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_disconnectNotify, NULL);
...
static PyObject *meth_QPanGesture_lastOffset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_lastOffset, NULL);
...
static PyObject *meth_QPanGesture_offset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_offset, NULL);
...
static PyObject *meth_QPanGesture_delta(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_delta, NULL);
...
static PyObject *meth_QPanGesture_acceleration(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_acceleration, NULL);
...
static PyObject *meth_QPanGesture_setLastOffset(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ9", &sipSelf, sipType_QPanGesture, &sipCpp, sipType_QPointF, &a0))
        {
            Py_BEGIN_ALLOW_THREADS
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_setLastOffset, NULL);
...
static PyObject *meth_QPanGesture_setOffset(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_setOffset, NULL);
...
static PyObject *meth_QPanGesture_setAcceleration(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    /* Raise an exception if the arguments couldn't be parsed. */
    sipNoMethod(sipParseErr, sipName_QPanGesture, sipName_setAcceleration, NULL);
...
static void release_QPanGesture(void *sipCppV,int sipState)
{
    Py_BEGIN_ALLOW_THREADS

    if (sipState & SIP_DERIVED_CLASS)
        delete reinterpret_cast<sipQPanGesture *>(sipCppV);
    else
        delete reinterpret_cast<QPanGesture *>(sipCppV);
...
extern "C" {static void *init_QPanGesture(sipSimpleWrapper *, PyObject *, PyObject *, PyObject **, PyObject **, PyObject **);}
static void *init_QPanGesture(sipSimpleWrapper *sipSelf, PyObject *sipArgs, PyObject *sipKwds, PyObject **sipUnused, PyObject **sipOwner, PyObject **sipParseErr)
{
...
static sipEncodedTypeDef supers_QPanGesture[] = {{144, 255, 1}};


static PyMethodDef methods_QPanGesture[] = {
    {SIP_MLNAME_CAST(sipName_acceleration), meth_QPanGesture_acceleration, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_childEvent), meth_QPanGesture_childEvent, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_connectNotify), meth_QPanGesture_connectNotify, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_customEvent), meth_QPanGesture_customEvent, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_delta), meth_QPanGesture_delta, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_disconnectNotify), meth_QPanGesture_disconnectNotify, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_lastOffset), meth_QPanGesture_lastOffset, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_offset), meth_QPanGesture_offset, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_receivers), meth_QPanGesture_receivers, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_sender), meth_QPanGesture_sender, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_setAcceleration), meth_QPanGesture_setAcceleration, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_setLastOffset), meth_QPanGesture_setLastOffset, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_setOffset), meth_QPanGesture_setOffset, METH_VARARGS, NULL},
    {SIP_MLNAME_CAST(sipName_timerEvent), meth_QPanGesture_timerEvent, METH_VARARGS, NULL}
};
